          ...
          initWebSocket() {
              this.global.ws.onmessage = (res) => {
                  try {
                      ...
                      if (data.dpmid === this.id) { // 如果数据的dpmId与当前页面的id相同
              ...
              // 获取图表元素失败
               ...
               let option = { 
                  ...
                  series: [ { 
                      ...
                      data: [], 
                      lineStyle: { 
                          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [ { offset: 0, color: "#ff0000" }, { offset: 1, color: "#ffffff" }, ]), // 设置渐变的淡红色 
                      }, 
                      }, ], 
                  };
