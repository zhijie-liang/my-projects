...
if __name__ == "__main__":
    json_file_path = "C:/Users/梁智杰/Desktop/新建文件夹/my-projects/src/components/map/json/500000.json"  # Replace with the path to your JSON file
    root_folder_name = "重庆"  # Replace with the name of the root folder
