...
# 打开文件并加载数据
with open("C:/Users/梁智杰/Desktop/新建文件夹/my-projects/public/map/dtsj3/all/440103.json", "r", encoding="utf-8") as file:
    data = json.load(file)
...
# 将处理后的数据保存回原JSON文件
with open("C:/Users/梁智杰/Desktop/新建文件夹/my-projects/public/map/dtsj3/all/440103.json", "w", encoding="utf-8") as file:
