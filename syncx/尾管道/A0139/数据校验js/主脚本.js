...
for (var i = 0; i < records.length; i++) {
  try {
    ...
    var obj = {};
    //////////////////////////////////////////////////////////////////////////////////
    obj.REMOTE_CONTROL_LOGIN_ID = records[i].value['root']['REMOTE_CONTROL_LOGIN_ID'];
    ...
    obj.LOGOUT_TIME = records[i].value['root']['LOGOUT_TIME'];
    obj.CONNECTION_TIME = records[i].value['root']['CONNECTION_TIME'];
    obj.LOGIN_FLAG = records[i].value['root']['LOGIN_FLAG'];
    obj.LOGIN_USER = records[i].value['root']['LOGIN_USER'];
    obj.KERNEL = records[i].value['root']['KERNEL'];
    // obj.KERNEL = state.convertNullToStr(records[i].value['root']['KERNEL']);
    obj.CLIENT_OS = records[i].value['root']['CLIENT_OS'];
    obj.STATUS = records[i].value['root']['STATUS'];
    ...
    if (count != 0) {
      ...
      ////////////////////////////////////////////////////////
      records[i].value.source_name = 'DSSP_REMOTE_CONTROL_LOGIN';
      ////////////////////////////////////////////////////////
