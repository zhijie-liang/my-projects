...
for (var i = 0; i < records.length; i++) {
  try {
    ...
    records[i].value.LOGIN_ERR_CODE = state.convertNullToStr(records[i].value['LOGIN_STATUS']);
    ...
    obj.RECORD_TIME = records[i].value['RECORDTIME_DM'];
    ...
    obj1.count = 3;
    obj1.ts = timestamp;
    obj1.id = '652cd3ee36bdb2308ae90b1b:origin';
